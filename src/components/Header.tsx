...
const navLinks: NavLink[] = [
  { label: "Home", href: "/" },
  {
    ...
    subLinks: [
      ...
      { label: "ET Nice Gate Motors", href: "/gate-motors/et-nice" },
      { label: "Gemini Gate Motors", href: "/gate-motors/gemini" },
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex items-center gap-4 xl:gap-6">
                ...
                {navLinks.map((link) => {
                  if (link.subLinks) {
                    return (
                      <li key={link.label} className="relative group py-2">
                        <button
                          className="text-white text-xs xl:text-sm font-medium px-2 xl:px-3 py-2 rounded hover:bg-white/10 transition-colors whitespace-nowrap flex items-center gap-1 cursor-default focus:outline-none"
                        >
                          {link.label}
                  ...
                  return (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-white text-xs xl:text-sm font-medium px-2 xl:px-3 py-2 rounded hover:bg-white/10 transition-colors whitespace-nowrap"
                      >
                        {link.label}
                      </Link>
                    </li>
              ...
              {/* Divider */}
              <span className="h-6 w-px bg-white/20 shrink-0" />
              ...
              <div className="flex items-center gap-2 xl:gap-4 shrink-0">
                ...
                >
                  ...
                  <span className="hidden xl:inline">082 498 1272</span>
                </a>
                <a
