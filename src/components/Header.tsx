...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      {/* Top contact bar */}
      <div style={{ backgroundColor: "#001d3b" }} className="text-white text-sm">
        <div className="max-w-7xl mx-auto px-4 py-2 flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              className="flex items-center gap-1.5 hover:text-blue-300 transition-colors hidden sm:flex"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="flex items-center gap-1.5 bg-green-600 hover:bg-green-700 px-3 py-1 rounded-full text-xs font-semibold transition-colors"
            >
            ...
            <ul className="py-2 px-4">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="block text-white py-2.5 text-sm hover:text-blue-300 transition-colors border-b border-white/5"
